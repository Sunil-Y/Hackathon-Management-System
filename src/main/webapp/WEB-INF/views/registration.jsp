...
<body>
	...
	<br />
	<br />
	<form action="${contextPath}/hacker/newVistor.htm" name="regform"
												...
												<tr>
													<td width="90">
														<div id="menu" align="center">
															<a href="${contextPath}/hacker/index.htm"> Login_Page </a>
														</div>
													</td>
												</tr>
											</tbody>
												...
												<tbody>
													<tr>
														<td align="center" colspan="2">
															<h3>New Hacker Registration Page</h3>
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><span
															style="font-weight: bold; color: red; font-size: 15px;">*</span>
															First Name:</td>
														<td><input type="text" name="FIRSTNAME" size="25"></input></td>
													...
													<tr>
														<td><span
															style="font-weight: bold; color: red; font-size: 15px;">*</span>
															Last Name:</td>
														<td><input type="text" name="LASTNAME" size="25"></input></td>
													...
													<tr>
														<td><span
															style="font-weight: bold; color: red; font-size: 15px;">*</span>
															User Name:</td>
														<td><input type="text" name="USERNAME" size="25"></input></td>
													...
													<tr>
														<td><span
															style="font-weight: bold; color: red; font-size: 15px;">*</span>
															Phone Number:</td>
														<td><input type="text" name="PHONENO" size="25"></input></td>

													</tr>
													<tr>
														<td>Address:</td>
														<td><input type="text" name="ADDRESS" size="25"></input>
														</td>
